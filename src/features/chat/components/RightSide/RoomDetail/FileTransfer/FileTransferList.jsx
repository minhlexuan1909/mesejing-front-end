...
const FileTransferList = ({setMODE_VIEW}) => {
    ...
    <div className="feature-room_container">
      <div className="feature-room_header">
        ...
        <span>Kho lưu trữ Ảnh, File</span>
      </div>
      <div className="files_tab">
        <Tabs defaultActiveKey="1">
            <TabPane tab="Ảnh" key="1">
                <div className="listImage_wrapper">
                    <Zoom zoomMargin={30}><img width="100" src="https://vtv1.mediacdn.vn/thumb_w/1000/2022/4/26/johnny-depp-trial-1650959633428176204555.jpg" alt="test"></img></Zoom>
                    <Zoom zoomMargin={30}><img width="100" src="https://vtv1.mediacdn.vn/thumb_w/1000/2022/4/26/johnny-depp-trial-1650959633428176204555.jpg" alt="test"></img></Zoom>
                    <Zoom zoomMargin={30}><img width="100" src="https://vtv1.mediacdn.vn/thumb_w/1000/2022/4/26/johnny-depp-trial-1650959633428176204555.jpg" alt="test"></img></Zoom>
                    <Zoom zoomMargin={30}><img width="100" src="https://vtv1.mediacdn.vn/thumb_w/1000/2022/4/26/johnny-depp-trial-1650959633428176204555.jpg" alt="test"></img></Zoom>
                    <Zoom zoomMargin={30}><img width="100" src="https://vtv1.mediacdn.vn/thumb_w/1000/2022/4/26/johnny-depp-trial-1650959633428176204555.jpg" alt="test"></img></Zoom>
